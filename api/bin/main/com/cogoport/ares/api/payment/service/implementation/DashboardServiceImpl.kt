...
class DashboardServiceImpl : DashboardService {
    ...
    override suspend fun getOverallStats(zone: String?, role: String?): OverallStatsResponse? {
        ...
        return OpenSearchClient().response<OverallStatsResponse>(
            searchKey = searchKey,
...
//        val invoiceResponse = OverallStatsResponse(
//            openInvoiceCount = 23,
...
//        )
//
//        val invoiceResponse2 = OverallStatsResponse(
//            openInvoiceCount = 27,
...
//        )
//
//        val invoiceResponse1 = OverallStatsResponse(
//            openInvoiceCount = 55,
...
//        )
        ...
        val dailySalesOutstanding1 = DailySalesOutstanding(
            ...
            dsoResponse = listOf(DsoResponse("Jan", 50.00), DsoResponse("Feb", 70.00)),
        ...
        val dailySalesOutstanding2 = DailySalesOutstanding(
            ...
            dsoResponse = listOf(DsoResponse("Jan", 40.00), DsoResponse("Feb", 80.00)),
...
//        Client.addDocument(AresConstants.SALES_DASHBOARD_INDEX, collectionTrend1)
    ...
    override suspend fun getCollectionTrend(zone: String?, role: String?, quarter: String): CollectionTrendResponse? {
        ...
        return OpenSearchClient().response<CollectionTrendResponse>(
            searchKey = searchKey,
            classType = CollectionTrendResponse ::class.java,
            index = AresConstants.SALES_DASHBOARD_INDEX,
            key = AresConstants.OPEN_SEARCH_DOCUMENT_KEY
        )
    }
    ...
    override suspend fun getReceivableByAge(zone: String?, role: String?): ReceivableAgeingResponse {
        ...
        var receivableNorthBucket = mutableListOf<AgeingBucketZone>()
        var receivableSouthBucket = mutableListOf<AgeingBucketZone>()
        var receivableEastBucket = mutableListOf<AgeingBucketZone>()
        var receivableWestBucket = mutableListOf<AgeingBucketZone>()
        var receivableZoneBucket = mutableListOf<AgeingBucketZone>()
