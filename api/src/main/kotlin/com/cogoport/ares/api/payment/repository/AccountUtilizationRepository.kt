...
interface AccountUtilizationRepository : CoroutineCrudRepository<AccountUtilization, Long> {
    ...
    @Query(
        """
            ...
            sum(case when acc_type in ('REC', 'CTDS','BANK', 'CONTR', 'ROFF', 'MTCCV', 'MISC', 'INTER', 'OPDIV', 'MTC') and document_status = 'FINAL' and abs(amount_curr - pay_curr) <> 0.001 then 1 else 0 end) as payments_count,
