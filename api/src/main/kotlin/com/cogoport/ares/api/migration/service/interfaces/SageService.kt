...
interface SageService {
    ...
    suspend fun getInvoicesPayLocDetails(startDate: String, endDate: String): ArrayList<InvoiceDetails>

    suspend fun getBillPayLocDetails(startDate: String, endDate: String): ArrayList<InvoiceDetails>
}
