...
enum class AresError(
    ...
    ERR_1527("ERR_1527", "Documents must be posted on Sage", HttpStatus.BAD_REQUEST),
    ERR_1528("ERR_1528", "Posting failed because of following org issue:", HttpStatus.BAD_REQUEST);
