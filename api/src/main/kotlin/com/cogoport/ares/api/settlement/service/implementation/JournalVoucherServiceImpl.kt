...
open class JournalVoucherServiceImpl : JournalVoucherService {
    ...
    private suspend fun createJvAccUtilForTds(
        ...
        val accountUtilEntity = AccountUtilization(
            ...
            payCurr = if (journalVoucher.accMode === AccMode.AP) payCurrTds!! else BigDecimal.ZERO,
            payLoc = if (journalVoucher.accMode === AccMode.AP) payLocTds!! else BigDecimal.ZERO,
            taxableAmount = BigDecimal.ZERO,
