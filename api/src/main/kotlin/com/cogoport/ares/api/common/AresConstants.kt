...
object AresConstants {
    ...
    var DUNNING_BANK_DETAILS = mapOf(
        ...
        501 to "<div><div style=\"border:1px solid #000;height:250px;margin: 0px 8px 16px 8px;\"><div style=\"height:65px;border-bottom:2px solid #000\"><p style=\"text-align:center;font-weight:600;font-size:15px;line-height:25px;padding:5px\">For VND Payments: CÔNG TY TNHH COGOPORT VIETNAM</p></div><div style=\"text-align:center;line-height:20px;\"><p>Name of Bank: Ngân hàng thương mại cổ phần Ngoại thương Việt Nam</p><p>SWIFT Code: BFTVVNVX</p><p>BANK CODE: 1035070768</p></div></div></div><div style=\"border:1px solid #000;height:250px; margin: 0px 8px 0px 8px;\"><div style=\"height:65px;border-bottom:2px solid #000;\"><p style=\"text-align:center;font-weight:600;font-size:15px;line-height:25px;padding:5px\">For USD Payments: CÔNG TY TNHH COGOPORT VIETNAM</p></div><div style=\"text-align:center;line-height:20px;\"><p>Name of Bank: Ngân hàng thương mại cổ phần Ngoại thương Việt Nam</p><p>SWIFT Code: BFTVVNVX</p><p>BANK CODE: 1035070860</p></div></div>\n"
    )
