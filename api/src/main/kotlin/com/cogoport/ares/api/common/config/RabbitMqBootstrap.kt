...
class RabbitMqBootstrap : ChannelInitializer() {
    ...
    override fun initialize(channel: Channel?, name: String) {
        ...
        channel?.queueDeclare("ares-bulk-update-payment-and-post-on-sage", true, false, false, null)
        channel?.queueBind("ares-bulk-update-payment-and-post-on-sage", "ares", "ares.bulk.update.payment.and.post.on.sage", null)
        ...
        channel?.queueDeclare("ares-bulk-post-payment-from-sage", true, false, false, null)
        channel?.queueBind("ares-bulk-post-payment-from-sage", "ares", "ares.bulk.post.payment.from.sage", null)
